...
import cell.customer.CellAddress;
import cell.customer.CellCustomerID;
import cell.customer.CellCustomerName;
import cell.customer.CellEmail;
import cell.customer.CellPhone;
import component.AddCustomer;
...
public class FormCustomer extends javax.swing.JPanel {
    ...
    public FormCustomer() {
        ...
        customers = databaseConnection.getCustomer();
        initDataTable();
    }

    private void initDataTable() {
        table.addTableCell(new CellCustomerID(), 0);
        table.addTableCell(new CellCustomerName(), 1);
    ...
    private void initComponents() {
        ...
        btnAddCustomer = new swing.login.Button();
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Last name", "First name", "Phone", "Email", "Address", "Action"
            }
        ));
        ...
        btnAddCustomer.setBackground(new java.awt.Color(242, 231, 213));
        btnAddCustomer.setForeground(new java.awt.Color(109, 152, 134));
...
//        this.setVisible(false);
    ...
    private swing.login.Button btnAddCustomer;
